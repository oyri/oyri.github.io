---
layout: default
title: "Gjesteinformasjon"
lang: nn
alt_lang: en
alt_url: ../en/guest-info
---
...
### Brytar for fleire lys

- Trykk `1` for å slå på lyset
- Trykk `0` for å slå av lyset
...
- Om det er for kaldt, ta kontakt med eigarane
- Om det er for varmt, luft ut og lukk eventuelt dørene til soveromma
- Nokre rom har også svarte termostatar på veggen for mindre justeringar

Ikkje juster hovudpanelet for varmen.
...
- Slå på med knappen heilt til venstre
- Vel program
- Trykk `Start`
...
Bruk av/på-knappen for å slå han på, vel kokesone, og bruk glidaren for å velje nivå. Dersom tryggingsfunksjonen på komfyren slår inn, må du slå av koketoppen, tørke vekk søl, og trykkje på komfyrvakta på veggen over.

### Frysar

Frysaren står i trappegangen. Kople han til om du vil bruke han.
...
Det finst også hurtigladarar i Sogndal.
...
Godt opphald på familiehytta vår.
